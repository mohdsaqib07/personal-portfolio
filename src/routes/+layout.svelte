...
<div
  class="container relative min-h-screen text-sm sm:text-base flex flex-col max-w-[1400px] mx-auto w-full"
>
  <div class={"fixed bottom-0 duration-200 w-full flex p-10 z-10 " + (
